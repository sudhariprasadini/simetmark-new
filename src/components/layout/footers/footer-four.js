        ...
        <div className="container">
          <div className="row jc-center">
            <div className="col-xl-12">
              <div
                className="cta__four-area t-center"
              ...
              >
                <div className="cta__four-area-content">
                  ...
                  <div className="wow fadeInDown" data-wow-delay="1.2s">
                    <Link className="build_button mt-40" to="/request-quote">
                      Free Consultation<i className="flaticon-right-up"></i>
                    </Link>
                  </div>
                </div>
              </div>
                  ...
                  <div className="col-lg-4 col-sm-6">
                    <div className="footer__four-widget mr-40">
                      <Link className="logo" to="/">
                        <img className="dark-n" src={logo1} alt="image" />
                        <img className="light-n" src={logo2} alt="image" />
                      </Link>
                  ...
                  <div className="col-lg-3 col-sm-6 sm-mt-30">
                    <div className="footer__four-widget address">
                      ...
                      <div className="footer__four-widget-address">
                        ...
                        <h4>
                          <Link to="tel:+123%20(256)%20568%2058">
                            +94717127987
                          </Link>
                        </h4>
                      </div>
