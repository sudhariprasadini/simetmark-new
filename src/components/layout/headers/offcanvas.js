  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Redefining the construction industry with innovative solutions,
          cuttin-edge technology and sustainable practices
        </p>
        <div className="header__area-menubar-right-sidebar-popup-contact">
          ...
          <div className="header__area-menubar-right-sidebar-popup-contact-item">
            ...
            <div className="header__area-menubar-right-sidebar-popup-contact-item-content">
              <span>Phone:</span>
              <h6>
                <Link to="tel:+123 (256) 568 58">+94717127987</Link>
              </h6>
            </div>
          </div>
          <div className="header__area-menubar-right-sidebar-popup-contact-item">
          ...
          <div className="header__area-menubar-right-sidebar-popup-contact-item">
            ...
            <div className="header__area-menubar-right-sidebar-popup-contact-item-content">
              <span>Location:</span>
              <h6>
                <Link to="https://google.com/maps" target="_blank">
